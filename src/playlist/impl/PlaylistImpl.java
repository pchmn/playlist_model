 ...
 * </p>
 * <ul>
 *   <li>{@link playlist.impl.PlaylistImpl#getMediaFile <em>Media File</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaylistImpl extends MinimalEObjectImpl.Container implements Playlist {
	...
	public EList<MediaFile> getMediaFile() {
		if (mediaFile == null) {
			mediaFile = new EObjectResolvingEList<MediaFile>(MediaFile.class, this, PlaylistPackage.PLAYLIST__MEDIA_FILE);
		}
		return mediaFile;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PlaylistPackage.PLAYLIST__MEDIA_FILE:
				return getMediaFile();
		}
